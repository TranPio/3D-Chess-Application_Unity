...
public class PlayFabController : MonoBehaviour
{
    ...
    public string userEmail2, userPassword2;
    ...
    {
        Debug.Log("Congratulations, you made your first successful API call!");
        PlayerPrefs.SetString("EMAIL", FireBase.emailNow);
        PlayerPrefs.SetString("PASSWORD", FireBase.userPassNow);
    ...
    public void OnClickLogin()
    {
        ...
        Debug.Log(FireBase.usernameNow);
        string email = FireBase.emailNow.Trim();
        string password = FireBase.userPassNow.Trim();

        // Đảm bảo kiểm tra biến đúng
        if (string.IsNullOrEmpty(email) || string.IsNullOrEmpty(password))
        {
            Debug.LogError("Email và mật khẩu là bắt buộc để đăng nhập.");
            return;
        }
